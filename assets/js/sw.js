(() => {
    ...
    s.n = e => {
        ...
        var e = s(89),
            ...
            r = s(522),
            i = s(634);
        const c = JSON.parse('["advantagecollc\\\\.com(?:/.*)?/ola/services/.*","advantagecollc\\\\.com/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://1427ae8e-85cc-4541-b48e-8bf9b7c597a4\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e => new RegExp(e))),
            o = JSON.parse('["advantagecollc\\\\.com(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/1427ae8e-85cc-4541-b48e-8bf9b7c597a4/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/1427ae8e-85cc-4541-b48e-8bf9b7c597a4/feed"]').map((e => new RegExp(e))),
            h = JSON.parse('["/services","/about-us","/","/contact-us"]').map((e => ({
                url: e,
                revision: "1672325233134"
            })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e => e.startsWith("advantagecollc.com-"))).map((e => caches.delete(e))))
            })))
